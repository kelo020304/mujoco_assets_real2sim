...
if __name__ == "__main__":
    ...
    # Extract mesh
    parser.add_argument('-l', '--surface_level', type=float, default=0.05, 
    ...
    parser.add_argument('--postprocess_density_threshold', type=float, default=0.3,
                        help='Threshold to use for postprocessing the mesh.')
    parser.add_argument('--postprocess_iterations', type=int, default=10,
