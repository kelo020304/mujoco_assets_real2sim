...
if __name__ == "__main__":
    ...
    parser.add_argument('--project_mesh_on_surface_points', type=str2bool, default=False, 
    ...
    parser.add_argument('--center_bbox', type=str2bool, default=False, help='If True, center the bounding box. Default is True.')
    
    parser.add_argument('--gpu', type=int, default=0, help='Index of GPU device to use.')
    
    parser.add_argument('--eval', type=str2bool, default=False, help='Use eval split.')
    parser.add_argument('--use_centers_to_extract_mesh', type=str2bool, default=True, 
